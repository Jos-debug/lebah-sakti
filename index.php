                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a
                      ...
                      style="background-image: url('assets/img/tisya1.png')"
                    >
                      <div class="img-bg-inner">
                        <h2>
                          Srikandi Lebah Sakti berhasil mempertahankan gelar
                          juara pada Kejuaraan Pencak Silat Tingkat Provinsi
                        </h2>
                        <p>
                  ...
                  <div class="swiper-slide">
                    <a
                      href="single-post.html"
                      class="img-bg d-flex align-items-end"
                      style="background-image: url('assets/img/gambar1.png')"
                    >
                      <div class="img-bg-inner">
                        <h2>
                  ...
                  <div class="swiper-slide">
                    <a
                      href="single-post.html"
                      class="img-bg d-flex align-items-end"
                      style="background-image: url('assets/img/gambar3.png')"
                    >
                      <div class="img-bg-inner">
                        <h2>
                  ...
                  <div class="swiper-slide">
                    <a
                      ...
                      class="img-bg d-flex align-items-end"
                      style="
                        background-image: url('assets/img/gambar1.png');
                      "
                    >
                      <div class="img-bg-inner">
                        <h2>
            ...
            <div class="col-lg-4">
              <div class="post-entry-1 lg">
                <a href="single-post.html"
                  ><img
                    src="assets/img/gambar1.png"
                    alt=""
                    class="img-fluid"
                /></a>
                <div class="post-meta">
                  <span class="date">Belinyu</span>
                  <span class="mx-1">&bullet;</span> <span>1 Agu 2024</span>
                </div>
                <h2>
                  <a href="single-post.html"
                    >Dipastikan srikandi lebah akan ikut serta dalam 17 agustus 2024 </a
                  >
                </h2>
              ...
              <div class="row g-5">
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry-1">
                    <a href="https://sumsel.kemenag.go.id/berita/view/443249/artikel/view/44481/index.html"
                      ><img
                        src="assets/img/berita1.png"
                        alt=""
                        class="img-fluid"
                    /></a>
                    <div class="post-meta">
                    ...
                    <h2>
                      <a href="https://sumsel.kemenag.go.id/berita/view/443249/artikel/view/44481/index.html"
                        >Tiga Siswa MAN Prabumulih Raih Tiga Mendali</a
                      >
                    </h2>
                  </div>
                  <div class="post-entry-1">
                    ...
                    <h2>
                      <a href="single-post.html"
                        >Pengesahan Anggota Baru Sekaligus Ujian peningkatan </a
                      >
                    </h2>
                  </div>
                  <div class="post-entry-1">
                    ...
                    /></a>
                    <div class="post-meta">
                      <span class="date">Pelembang</span>
                      <span class="mx-1">&bullet;</span>
                      <span>17 Mei 2024</span>
                    </div>
                    <h2>
                      <a href="single-post.html"
                        >Kenapa beladiri sangat dibutuhkan</a
                      >
                    </h2>
                  </div>
                </div>
